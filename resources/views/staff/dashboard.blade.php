    ...
    <div>
        <div class="grid grid-cols-4 gap-5">
            <div class="bg-gradient-to-bl from-gray-700 to-gray-500 p-5 rounded-2xl shadow-md relative overflow-hidden">
                ...
                <div class="mt-5">
                    <h1 class="text-5xl font-black text-white">
                        {{ \App\Models\VisitorAttendance::whereDate('date_of_attendance', now())->count() }}</h1>
                    <h1 class="text-gray-200 mt-1 text-sm">Today's Visit</h1>
                </div>
            </div>
            <div class="bg-gradient-to-bl from-gray-700 to-gray-500 p-5 rounded-2xl shadow-md relative overflow-hidden">
                <img src="{{ asset('images/cell.jpg') }}"
            ...
            <div class="bg-gradient-to-bl from-gray-700 to-gray-500 p-5 rounded-2xl shadow-md relative overflow-hidden">
                ...
                <div class="mt-5">
                    <h1 class="text-5xl font-black text-white">
                        {{ \App\Models\Visitor::whereDate('created_at', now())->count() }}</h1>
                    <h1 class="text-gray-200 mt-1 text-sm">Visitor's Registration Form</h1>
                </div>
            </div>
